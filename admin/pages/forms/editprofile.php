<?php
    ...
    $query = mysqli_query($conn, "SELECT * FROM users WHERE id = $userid AND roles == 'Admin' ");
            ...
            <nav class="navbar default-layout-navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
                <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-center">
                    <a class="navbar-brand brand-logo" href="../../index.php"><img
                            src="../../assets/images/gmall-logo.jpeg" alt="logo" />
                    </a>
                                        ...
                                        <form class="forms-sample" method="POST" action="#">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" name="name" id=""
                                                    value="<?php echo $edit_result['Uname']; ?>" placeholder="Name">
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="email" class="form-control" name="email"
                                                    id="exampleInputEmail3" value="<?php echo $edit_result['Uemail'];?>"
                                                    placeholder="Email">
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" name="phone"
                                                    ...
                                                    value="<?php echo $edit_result['Uphone'] ;?>"
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" name="address"
                                                    id="exampleInputEmail3"
                                                    value="<?php echo $edit_result['Uaddress'];?>"
                                                    placeholder="Address">
                                            </div>
                                            ...
                                            <div class="form-group">
                                                <label for="exampleInputCity1">Talent</label>
                                                <input type="text" class="form-control" name="talent"
                                                    value="<?php echo $edit_result['Utalent'];?>" id="exampleInputCity1"
                                            ...
                                            <div class="form-group">
                                                ...
                                                <textarea class="form-control" name="bio" id="exampleTextarea1"
                                                    value="<?php echo $edit_result['Umessage'];?>" rows="4"></textarea>
                                            </div>


                                            <button type="submit" name="submit"
                                                class="btn btn-gradient-secondary mr-2">Submit</button>
