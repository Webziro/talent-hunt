                            ...
                            <div class="dropdown-menu dropdown-menu-right navbar-dropdown preview-list"
                                ...
                                <a class="dropdown-item preview-item">
                                    ...
                                    <div
                                        ...
                                        <h6 class="preview-subject ellipsis mb-1 font-weight-normal">GMALLY send you a
                                            message
                                        </h6>
                    ...
                    <div class="content-wrapper">
                        ...
                        <div class="row">
                            <div class="col-lg-4 grid-margin stretch-card">
                                <div class="card">
                                    <div class="card-body">
                                        <h4 class="card-title">Your GMALLY Profile</h4>
                                        ...
                                        <img src="../../assets/images/faces/face2.jpg"
                                            style="border-radius: 20px; margin-left:25%; border: 2px solid orange"
                                            height="100px" alt="" sizes="" srcset="">
                                        <br><br>
                                        Code ::: <strong>
